...
const Home = () => {
  ...
  return (
    <div
      ...
      }  gap-10 flex-col px-56 pt-16 mt-28 overflow-hidden`}
    >
      ...
      <div className="w-fit relative">
        ...
        <div className="absolute bottom-10 mx-auto left-4 flex w-full items-end object-contain gap-5">
          ...
          />
          <img src={categories3} alt="Category 3" className="object-contain" />
        </div>
      </div>
      <div className="w-fit relative rounded overflow-hidden">
        ...
        <div className="absolute bottom-12 justify-end right-14 flex w-full  gap-5">
          <div className="flex flex-col">
            ...
            <img src={home_decor} alt="Home decor" className="cursor-pointer" />
          </div>
          <div className="flex flex-col">
      ...
      <div className="relative">
        <img src={supply_banner} alt="Supplier banner" className="rounded-sm" />
      ...
      <h1 className="text-4xl mb-5 text-start font-mier-bold font-semibold text-slate-700">
        Products for you
      </h1>
    </div>
  );
